...
Gene::Shape Gene::getType() const { return m_type; }
sf::Vector2f Gene::getSize() const { return m_size; }
float Gene::getRotation() const { return m_rotation; }
sf::Color Gene::getColor() const { return m_color; }
sf::Vector2f Gene::getPos() const { return m_pos; }
